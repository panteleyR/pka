...
//$inputKey = 'ffeeddccbbaa99887766554433221100f0f1f2f3f4f5f6f7f8f9fafbfcfdfeff';
...
$blockSize = 64;
$inputText = TextHexBinConverter::addingBitsToBlockSize($inputText, $blockSize);
...
$magma = new Magma($inputTextHex, $inputKey);
...
$magma = new Magma($resHex, $inputKey);
$resHex = $magma->decrypt();

print_r('Расшифровка:'."<br>");
//print_r(TextHexBinConverter::convertHexToText($resHex)."<br>");
print_r(TextHexBinConverter::convertHexToText($inputTextHex)."<br>");
